        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              the TraceIT website and services (collectively, the "Services").
            ...
            <p>
              TraceIT provides a software solution designed to help Canadian
              food businesses meet CFIA traceability requirements. The specific
              features and functionality of the Services may change from time to
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li>
                Attempt to gain unauthorized access to the Services or any
            ...
            <p>
              ...
              displays, images, video, audio, design, selection, arrangement,
              and look and feel, are owned by us, our licensors, or other
            ...
            <p>
              ...
              Services or our content. You may not reproduce, distribute,
            ...
            <p>
              ...
              SERVICES ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; OR (D)
              THE RESULTS OF USING THE SERVICES WILL MEET YOUR REQUIREMENTS.
            </p>
            <p>
              WHILE WE DESIGN OUR SERVICES TO HELP USERS MEET CFIA REQUIREMENTS,
              WE MAKE NO GUARANTEES ABOUT REGULATORY COMPLIANCE OR ACCEPTANCE BY
              ANY REGULATORY AUTHORITY. YOU ARE SOLELY RESPONSIBLE FOR ENSURING
            ...
            <p className="font-medium">
              ...
              SHALL WE, OUR AFFILIATES, DIRECTORS, EMPLOYEES, AGENTS, OR
            ...
            <p>
              UNDER NO CIRCUMSTANCES WILL OUR AGGREGATE LIABILITY FOR ALL CLAIMS
              RELATING TO THE SERVICES EXCEED THE GREATER OF $100 CAD OR THE
              AMOUNT PAID BY YOU TO US FOR THE SERVICES DURING THE TWELVE (12)
            ...
            <p>
              ...
              our subsidiaries, affiliates, officers, agents, and employees,
              from and against any claims, liabilities, damages, losses, and
              expenses, including without limitation reasonable attorney's fees
              and costs, arising out of or in any way connected with your access
              to or use of the Services, your violation of these Terms, or your
            ...
            <p>
              ...
              [Province], Canada, without giving effect to any choice or
              conflict of law provision or rule.
            </p>
            <p>
              Any legal action or proceeding arising out of or relating to these
              Terms or the Services shall be instituted exclusively in the
              courts located in [City], [Province], Canada, and you irrevocably
              submit to the jurisdiction of such courts in any such action or
              proceeding.
            </p>
            ...
            <p>
              ...
              us regarding the Services and supersede all prior and
            ...
            <p>
              Questions or comments about the Services or these Terms may be
              directed to:
            </p>
